...
const GraduationForm = () => {
  const handleSubmit = (e) => {
    ...
    const value = {
      ...
      haveFailure: field.failure.value === "failure" ? true : false,
    };
    console.log(value);
    axios.post("http://localhost:5000/graduation", value).then((res) => {
    ...
    <div className="mt-10">
      ...
      <form onSubmit={handleSubmit}>
        ...
        <section className="grid md:grid-cols-2 pl-10 lg:pl-0 gap-y-4">
          ...
          <div className="max-w-xs lg:max-w-sm flex justify-between  items-center mx-auto w-full ">
            <label className="label">
              <span className="mr-2">Your Total CGPA</span>
            </label>
            <input
              type="number"
              className="input input-bordered rounded-md w-48"
          ...
          {/* Carry or Not */}
          <div className="max-w-xs lg:max-w-sm flex  justify-between items-center mx-auto w-full">
            <p>Have You comple your all course? </p>
